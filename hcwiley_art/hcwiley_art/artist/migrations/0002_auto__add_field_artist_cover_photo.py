...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Artist.cover_photo'
        db.add_column(u'artist_artist', 'cover_photo',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='cover_photo', null=True, to=orm['artist.ParentMedia']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Artist.cover_photo'
        db.delete_column(u'artist_artist', 'cover_photo_id')
